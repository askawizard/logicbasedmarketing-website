...
(function() {
  ...
  overlay.innerHTML = [
    ...
    '    <div class="lbm-popup-stat"><span class="lbm-popup-num">Free</span><span class="lbm-popup-label">takes 90 seconds</span></div>',
    '  </div>',
    '  <a href="/calculator.html" id="lbm-popup-cta">Calculate Your Real All-In CAC &rarr;</a>',
